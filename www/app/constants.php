...
// Text message
define('TEXT_MSG_APPOINTMENT_BOOKING_CONFIRMATION', 'Dear {patient_name}, Confirmation of appointment on {appointment_time} at {hospital_name}. For queries call {hospital_phone_number}. '. '/n'. 'Regards,' .'/n' . NAME . '.');
