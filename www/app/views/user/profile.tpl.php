<form action="<?php echo $action; ?>" method="post" class="row pt-3">
    ...
    <div class="col-md-4">
        <div class="input-box">
            <input type="text" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" value="<?php echo $user_data['email']; ?>" readonly required>
    ...
    <div class="col-md-4">
        <div class="input-box">
            <input type="text" name="dob" value="<?php echo date_format(date_create($user_data['dob']), $siteinfo['date_format']); ?>" required>
