...
<div class="appointment-wrapper">
	<form class="appointment-form">
		<div class="appointment">
			...
			<div class="input-box doctor-box">
				<select name="consultation_type" class="consultation_type" required>
					<option value=""><?php echo $lang['text_choose_consultation_type']; ?></option>
					<?php if (!empty(CONSULTATION_TYPE)) { foreach (CONSULTATION_TYPE as $consultation_type_key => $consultation_type_value) { ?>
						<option value="<?php echo $consultation_type_key ?>" ><?php echo $consultation_type_value; ?></option>
					<?php } } ?>
				</select>
				<label><?php echo $lang['text_choose_consultation_type']; ?></label>
			</div>
