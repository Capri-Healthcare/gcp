...
<?php } if (isset($page['page_data']['about']['status']) && $page['page_data']['about']['status'] == '1') { ?>
	...
	<div id="hm-about" class="hm-parallax" style="background-image: url(<?php echo 'public/uploads/'.$page['page_data']['about']['background']; ?>);">
		<div class="layer-stretch">
			<div class="layer-wrapper animated-wrapper">
				...
				<div class="row align-items-center">
					<div class="hm-about-left col-md-7">
						...
						<div class="hm-about-paragraph">
							<p class="paragraph-medium paragraph-white animated animated-up"><?php echo $page['page_data']['about']['description']; ?></p>
						</div>
					</div>
					<div class="hm-about-right col-md-5">
						<img class="img-thumbnail animated animated-up" src="public/uploads/<?php echo $page['page_data']['about']['picture']; ?>" alt="">
					</div>
				</div>
			</div>
		</div>
...
<?php } if (isset($page['page_data']['doctor']['status']) && $page['page_data']['doctor']['status'] == '1') { ?>
	...
	<div class="hm-parallax" style="background-image: url(<?php echo 'public/uploads/'.$page['page_data']['doctor']['background']; ?>);">
		<div class="layer-stretch">
			<div class="layer-wrapper animated-wrapper">
				<div class="layer-ttl layer-ttl-white">
...
<?php } if (isset($page['page_data']['testimonial']['status']) && $page['page_data']['testimonial']['status'] == '1') { ?>
	...
	<div id="testimonial" class="hm-parallax" style="background-image: url(<?php echo 'public/uploads/'.$page['page_data']['testimonial']['background']; ?>);">
