					...
					<?php if (!empty($services)) { foreach ($services as $value) { ?>
						<div class="col-12 col-md-4">
							<div class="service-card">
								...
								<p class="paragraph-small paragraph-black"><?php echo $value['short_post']; ?></p>
								<div class="text-right"><a href="<?php echo URL.DIR_ROUTE.'service&name='.$value['service_url']; ?>" class="text-primary"><?php echo $lang['text_read_more']; ?></a></div>
							</div>
						</div>
					<?php } } ?>
				</div>
