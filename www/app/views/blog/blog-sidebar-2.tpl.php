		...
		<ul class="slides">
			...
			<li>
				<div class="theme-flexslider-container">
					...
					<div class="font-12 pull-right">( <?php echo $value['hits']; ?> Views )</div>
				</div>
			</li>
			<?php } } ?>
		</ul>
...
<div class="sidebar">
	...
	<ul class="category-list">
		...
		<li><a href="<?php echo URL.DIR_ROUTE.'category&id='.$value['id'].'/'.$value['name']; ?>"><i class="fa fa-<?php if(!empty($value['icon'])) { echo $value['icon']; } else { echo "fa-newspaper-o"; } ?>"></i><?php echo $value['name']; ?></a><span>(<?php echo $value['count']; ?>)</span></li>
		<?php } } } ?>
	</ul>
</div>