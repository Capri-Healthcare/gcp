            ...
            <div class="col-sm-6 text-right">
                ...
                if ($page_pdf) { ?>
                    <a href="<?php echo URL_ADMIN . DIR_ROUTE . 'invoice/pdf&id=' . $result['id']; ?>"
                       class="btn btn-danger btn-sm" target="_blank"><i class="far fa-file-pdf mr-2"></i>PDF/Print</a>
                <?php }
                if ($page_edit) { ?>
                    <a href="<?php echo URL_ADMIN . DIR_ROUTE . 'invoice/edit&id=' . $result['id']; ?>"
                       class="btn btn-primary btn-sm"><i class="ti-pencil-alt mr-2"></i>Edit</a>
                <?php }
                if ($page_addpayment) { ?>
                    <a class="btn btn-warning btn-sm" data-toggle="modal" data-target="#addPayment"><i
                                class="ti-wallet mr-2"></i>Add Payment</a>
                <?php } ?>
                <a data-toggle="modal" class="btn btn-info btn-sm" data-target="#attach-file"
                   class="btn btn-secondary btn-sm"><i class="ti-clip"></i></a>
            </div>
        </div>
    </div>
                ...
                <div class="inv-template-bdy table-responsive p-4">
                    ...
                    <div class="item table-responsive">
                        <table>
                            ...
                            <?php if (!empty($result['items'])) {
                                foreach ($result['items'] as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <!--											<div><span>-->
                                        <?php //echo $common['info']['currency_abbr'].$tax_value['tax_price']; ?><!--</span><span>-->
                                        <?php //echo $tax_value['name']; ?><!--</span></div>-->
                                        <!--										--><?php //} } ?>
                                        <!--									</td>-->
                            ...
                            <!--								<td class="value">-->
                            <?php //echo $common['info']['currency_abbr'].$result['tax']; ?><!--</td>-->
                            <!--							</tr>-->
                            <tr class="total">
                        ...
                        <div class="panel-head">
                            ...
                            <div class="panel-action">
                                <?php if ($page_addpayment) { ?>
                                    <a class="btn btn-warning btn-sm" data-toggle="modal" data-target="#addPayment"><i
                                                class="ti-wallet mr-1"></i> Add Payment</a>
                                <?php } ?>
                            </div>
                        </div>
                                    ...
                                    foreach ($attachments as $key => $value) {
                                        ...
                                        if ($file_ext == "pdf") { ?>
                                            <div class="attachment-image attachment-pdf">
                                                <a href="../public/uploads/attachments/<?php echo $value['file']; ?>"
                                                   class="open-pdf">
                                                    <img src="../public/images/pdf.png" alt="">
                                                </a>
                                                <div class="attachment-delete" data-toggle="tooltip" title="Delete"><a
                                                            class="ti-close"></a></div>
                                        ...
                                        <?php } else { ?>
                                            <div class="attachment-image">
                                                <a data-fancybox="gallery"
                                                   href="../public/uploads/attachments/<?php echo $value['file']; ?>">
                                                    <img src="../public/uploads/attachments/<?php echo $value['file']; ?>"
                                                         alt="">
                                                </a>
                                                <div class="attachment-delete" data-toggle="tooltip" title="Delete"><a
                                                            class="ti-close"></a></div>
                ...
                <form action="<?php echo $action; ?>" method="post">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="payment[amount]"
                                   value="<?php echo $result['due']; ?>" placeholder="Amount" required>
                        </div>
                        <div class="form-group">
                            <label class="col-form-label">Payment Date</label>
                            <input type="text" class="form-control date" name="payment[date]"
                                   value="<?php echo date_format(date_create(), $common['info']['date_format']); ?>"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="<?php echo URL_ADMIN . DIR_ROUTE . 'attach/documents'; ?>" class="dropzone"
                          id="attach-file-upload"></form>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="invoiceMail" class="modal fade" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="<?php echo URL_ADMIN . DIR_ROUTE . 'invoice/sentmail'; ?>" method="post"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" name="mail[attachPdf]" class="custom-control-input" value="1"
                                       id="mailPdf" checked>
