...
<form action="<?php echo $action ?>" method="post">
	<div class="panel panel-default">
		...
		<input type="hidden" name="hidden_membership_number" id="hidden_membership_number" value="<?php echo $result['membership_number']; ?>">
		<input type="hidden" name="hidden_scheme_name" id="hidden_scheme_name" value="<?php echo $result['scheme_name']; ?>">
		<input type="hidden" name="hidden_authorisation_number" id="hidden_authorisation_number" value="<?php echo $result['authorisation_number']; ?>">
		...
		<div class="panel-body">
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						<div class="input-group">
							...
							<input type="text" name="invoice[email]" id="patient-email" class="form-control patient-mail" value="<?php echo $result['email']; ?>" placeholder="Enter Patient Email Address . . ." required>
						</div>
					</div>
				</div>
				<div class="col-md-3">
						...
						<div class="input-group">
							...
							<select name="invoice[method]" class="custom-select" id="payment_method" required>
								<?php $selected_payment_method = "";
									if ($payment_method) { foreach ($payment_method as $key => $value) { ?>
									<option value="<?php echo $value['id'] ?>" <?php if ($result['method'] == $value['id']) { $selected_payment_method = $value['name']; echo "selected"; } ?>><?php echo $value['name']; ?></option>
								<?php } } ?>
							</select>
						</div>
					</div>
			...
			<div class="row" id="insurers_data_div" style="<?php echo ($selected_payment_method == 'Insurance') ? '' : 'display:none'; ?>">
				<div class="col-sm-4">
					<div class="form-group">
						<label class="col-form-label">Medical insurers name</label>
						<div class="input-group">
							<div class="input-group-prepend"><span class="input-group-text"><i class="ti-check-box"></i></span></div>
							<select name="invoice[medical_insurers_name]" id="medical_insurers_name" class="custom-select">
				...
				<div class="col-sm-4">
					<div class="form-group">
						...
						<div class="input-group">
							<div class="input-group-prepend"><span class="input-group-text"><i class="ti-check-box"></i></span></div>
							<input type="text" name="invoice[policyholders_name]" id="policyholders_name" class="form-control" value="<?php echo $result['policyholders_name']; ?>" placeholder="Enter Policyholder's name . . .">
						</div>
					</div>
				</div>
				<div class="col-sm-4">
					<div class="form-group">
						...
						<div class="input-group">
							<div class="input-group-prepend"><span class="input-group-text"><i class="ti-check-box"></i></span></div>
							<input type="text" name="invoice[membership_number]" id="membership_number" class="form-control" value="<?php echo $result['membership_number']; ?>" placeholder="Enter Membership number . . .">
						</div>
					</div>
				</div>
				<div class="col-sm-4">
					<div class="form-group">
						...
						<div class="input-group">
							<div class="input-group-prepend"><span class="input-group-text"><i class="ti-check-box"></i></span></div>
							<input type="text" name="invoice[scheme_name]" id="scheme_name" class="form-control" value="<?php echo $result['scheme_name']; ?>" placeholder="Enter Scheme name name . . .">
						</div>
					</div>
				</div>
				<div class="col-sm-4">
					<div class="form-group">
						...
						<div class="input-group">
							<div class="input-group-prepend"><span class="input-group-text"><i class="ti-check-box"></i></span></div>
							<input type="text" name="invoice[authorisation_number]" id="authorisation_number" class="form-control" value="<?php echo $result['authorisation_number']; ?>" placeholder="Enter Authorisation number . . .">
						</div>
					</div>
				</div>
				<div class="col-sm-4">
					<div class="form-group">
						...
						<div class="input-group">
							<div class="input-group-prepend"><span class="input-group-text"><i class="ti-check-box"></i></span></div>
							<input type="text" name="invoice[employer]" id="employer" class="form-control" value="<?php echo $result['employer']; ?>" placeholder="Enter employer name . . .">
						</div>
					</div>
				</div>
			</div>
