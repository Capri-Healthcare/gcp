        ...
        <div class="col-sm-6">
            ...
            <div class="breadcrumbs d-inline-block">
                <ul>
                    ...
                    <li><a href="<?php echo URL_ADMIN . DIR_ROUTE . 'leaflet'; ?>">Leaflet</a>
                    ...
                    <ul class="v-menu text-left pt-0 nav d-block">
                      ...
                      <?php } ?>
                        <?php if ($page_edit) { ?>
                            ...
                            <li><a href="<?php echo URL_ADMIN.DIR_ROUTE.'leaflet/edit&id='.$result['id']; ?>"><i class="ti-pencil-alt"></i> <span>Edit Referral Details</span></a></li>
                        <?php }  ?>
                        <?php }  ?>
                    </ul>
                </div>
                            ...
                            <div class="report-container">
                                <?php if (!empty($reports)) { foreach ($reports as $key => $value) { $file_ext = pathinfo($value['filename'], PATHINFO_EXTENSION); if ($file_ext == "pdf") { ?>
                                    <div class="report-image report-pdf">
                                        <a href="../public/uploads/leaflet/document/<?php echo $value['referral_list_id'] . '/'.$value['filename']; ?>" class="open-pdf font-12" style="display: block;">
                                ...
                                <?php } else {?>
                                    <div class="report-image">
                                        <a data-fancybox="gallery" href="../public/uploads/leaflet/document/<?php echo $value['referral_list_id'] . '/'. $value['filename']; ?>">
                                            <img class="img-thumbnail" src="../public/uploads/leaflet/document/<?php echo $value['referral_list_id'] . '/'.$value['filename']; ?>" alt="">
                                            <span><?php echo $value['name']; ?></span>
                                        </a>
