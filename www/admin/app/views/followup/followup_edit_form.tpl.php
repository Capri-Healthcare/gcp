...
<div class="page-title">
    <div class="row align-items-center">
        ...
        <div class="col-sm-6 text-right">
            <a href="<?php echo URL_ADMIN . DIR_ROUTE . 'follow-up'; ?>" class="btn btn-white btn-sm"><i class="ti-calendar text-primary mr-2"></i> View Followup</a>
        </div>
    </div>
</div>
        ...
        <div class="tab-content pt-4">
            <div class="tab-pane  <?php echo (!isset($_GET['document']) ? 'active' : '') ?>" id="appointment-info">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" onsubmit="return validateMyForm(event);">
                    ...
                    <input type="hidden" name="referral[patient_id]" class="patient_id" value="<?php echo $followup['patient_id']; ?>">
                    <input type="hidden" name="referral[id]" class="id" value="<?php echo $followup['id']; ?>">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="referral[first_name]" class="form-control" value="<?php echo $result['firstname']; ?>" placeholder="First Name" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-prepend"><span class="input-group-text"><i class="ti-user"></i></span></div>
                                            <input type="text" name="referral[last_name]" class="form-control" value="<?php echo $result['lastname']; ?>" placeholder="Last Name" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="referral[dob]" class="form-control dateofbirth" value="<?php echo date_format(date_create($result['dob']), $common['info']['date_format']); ?>" max="<?php echo date('Y-m-d') ?>" placeholder="dd-mm-yy" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="referral[address_1]" class="form-control" placeholder="Enter Address line 1" value="<?php echo $result['address']['address1']; ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="referral[address_2]" class="form-control" placeholder="Enter Address line 2" value="<?php echo $result['address']['address2']; ?>">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="referral[city]" class="form-control" value="<?php echo $result['address']['city']; ?>" placeholder="Enter City">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="referral[zip_code]" maxlength="8" class="form-control" value="<?php echo $result['address']['postal']; ?>" placeholder="Enter Post Code" onkeypress="return alphaNumericValidation(event)">
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php foreach (constant('HOSPITAL_LIST') as $key => $list) { ?>
                                                <div class="custom-control custom-radio custom-radio-1 d-inline-block">
                                                    <input type="radio" name="referral[hospital_code]" class="custom-control-input hospital_code" value="<?php echo $key; ?>" id="" checked>
                                                    <label class="custom-control-label" for="prescription_template-template-1">&nbsp;<b><?php echo $list['name'] ?></b></label>
                                                    <label class="ml-4 mt-1">
                                                        <i class="ti-mobile"></i><?php echo $list['mobile'] ?> &nbsp;&nbsp;<i class="ti-email"></i>&nbsp;<?php echo $list['email'] ?>
                                                        <br><i class="ti-location-pin"></i><?php echo $list['address'] ?><br><i class="ti-world"></i>&nbsp;<?php echo $list['web'] ?>
                                                    </label>
                                                </div>
                                                <hr />
                                            <?php } ?>
                                ...
                                <?php } else { ?>
                                    <input type="hidden" name="referral[hospital_code]" value="<?php echo $result['hospital_code'] ?>">
                                <?php } ?>
                            </div>
                            ...
                            foreach ($reports as $key => $value) {
                                ...
                                if ($file_ext == "pdf") { ?>
                                    <div class="report-image report-pdf" id="report-delete-div-<?php echo $value['id'] ?>">
                                        <a href="../public/uploads/optician-referral/followup/<?php echo $_GET['id'] . "/" . $value['filename']; ?>" class="open-pdf">
                                            <img src="../public/images/pdf.png" alt="">
                                            <span><?php echo $value['name']; ?></span>
                                        </a>
                                        <div class="report-delete" data-toggle="tooltip" title="Delete"><a class="ti-close report-delete-action" data-toggle="modal" data-target="#reportDeleteModel" data-appointment_id="<?php echo $value['followup_id'] ?>" data-report_name="<?php echo $value['filename'] ?>" data-report_id="<?php echo $value['id'] ?>"></a></div>
                                ...
                                <?php } else { ?>
                                    <div class="report-image" id="report-delete-div-<?php echo $value['id'] ?>">
                                        <a data-fancybox="gallery" href="../public/uploads/optician-referral/followup/<?php echo $_GET['id'] . "/" . $value['filename']; ?>">
                                            <img src="../public/uploads/optician-referral/followup/<?php echo  $_GET['id'] . "/" . $value['filename']; ?>" alt="">
                                            <span><?php echo $value['name']; ?></span>
                                        </a>
                                        <div class="report-delete" data-toggle="tooltip" title="Delete"><a class="ti-close report-delete-action" data-toggle="modal" data-target="#reportDeleteModel" data-appointment_id="<?php echo $value['followup_id'] ?>" data-report_name="<?php echo $value['filename'] ?>" data-report_id="<?php echo $value['id'] ?>"></a></div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="media-upload-container" style="max-width: 100%;">
                    <form action="<?php echo URL_ADMIN . DIR_ROUTE ?>follow-up/report/reportUpload" class="dropzone" id="followup-upload" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="_token" value="<?php echo $token; ?>" id="token">
                        <input type="hidden" class="followup-id" name="followup[id]" value="<?php echo $id; ?>">
                        <input type="hidden" class="id" name="id" value="<?php echo  $followup['optician_id']; ?>">
