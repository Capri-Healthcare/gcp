        ...
        <div class="tab-content">
            <div class="tab-pane fade <?php echo !isset($doc_type) ? 'show active' : ''; ?>" id="appointment-info">
                <div class="panel panel-default">
                    <div class="panel-head">
                        <div class="panel-title">Appointment Info | <?php echo $result['name']; ?>
                            | <?php echo date_format(date_create($result['patient_dob']), $common['info']['date_format']); ?></div>
                    ...
                    <div class="panel-body">
                        <div class="table-responsive" style="overflow-x: hidden !important;">
                            <table class="table table-striped patient-table">
                                ...
                                <!--                                        <td class="text-dark">-->
                                <?php //echo CONSULTATION_TYPE[$result['consultation_type']]; ?><!--</td>-->
                                <!--                                    </tr>-->
                                <!--                                    <tr>-->
                                <!--                                        <td>Reason/Problem</td>-->
                                <!--                                        <td class="text-dark">-->
                                <?php //echo $result['message']; ?><!--</td>-->
                                <!--                                    </tr>-->
                                <tr>
                                    <td>Patient Name</td>
            ...
            <?php if ($page_notes) { ?>
                <div class="tab-pane fade" id="appointment-records">
                    <div class="panel panel-default">
                        <div class="panel-head">
                            <div class="panel-title">Examination Notes | <?php echo $result['name']; ?>
                                | <?php echo date_format(date_create($result['patient_dob']), $common['info']['date_format']); ?></div>
                            <?php /* if (!empty($notes)) { ?>
                                ...
                                <table class="table table-striped patient-table">
                                        ...
                                        <td class="text-dark">
                                            <table style="padding: 0px;">
                                                <tr>
                                                    ...
                                                    <td style="padding:0px;">
                                                        <b>LE: </b><?php echo isset($result['disc_oct_comment_left']) ? $result['disc_oct_comment_left'] : '' ?>
                                                    </td>
                                                    </td>
                                                </tr>
                                            </table>
                                        ...
                                        <td class="text-dark">
                                            <table style="padding: 0px;">
                                                <tr>
                                                    ...
                                                    <td style="padding:0px;">
                                                        <b>LE: </b><?php echo isset($result['nfl_thickness_left']) ? $result['nfl_thickness_left'] . " mm" : '' ?>
                                                    </td>
                                                    </td>
                                                </tr>
                                            </table>
                                        ...
                                        <td class="text-dark">
                                            <table style="padding: 0px;">
                                                <tr>
                                                    ...
                                                    <td style="padding:0px;">
                                                        <b>LE: </b><?php echo isset($result['disc_oct_comment_left']) ? $result['fundus_comment_left'] : '' ?>
                                                    </td>
                                                    </td>
                                                </tr>
                                            </table>
                                        ...
                                        <td class="text-dark">
                                            <table style="padding: 0px;">
                                                <tr>
                                                    ...
                                                    <td style="padding:0px;">
                                                        <b>LE: </b><?php echo isset($result['visual_field_test_plots_comment_left']) ? $result['visual_field_test_plots_comment_left'] : '' ?>
                                                    </td>
                                                    </td>
                                                </tr>
                                            </table>
                                        ...
                                        <td class="text-dark">
                                            <table style="padding: 0px;">
                                                <tr>
                                                    ...
                                                    <td style="padding:0px;">
                                                        <b>LE: </b><?php echo isset($result['mean_deviation_left']) ? $result['mean_deviation_left'] . " db" : '' ?>
                                                    </td>
                                                    </td>
                                                </tr>
                                            </table>
                                        ...
                                        <td class="text-dark">
                                            <table style="padding: 0px;">
                                                <tr>
                                                    ...
                                                    <td style="padding:0px;">
                                                        <b>LE: </b><?php echo isset($result['psd_deviation_left']) ? $result['psd_deviation_left'] . " db" : '' ?>
                                                    </td>
                                                    </td>
                                                </tr>
                                            </table>
                                    ...
                                    <!-- <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-dark"><?php echo isset($result['diagnosis_other_le']) ? $result['diagnosis_other_le'] : '' ?></td>
                                        </tr> -->
                                    <tr>
                                        <td>Operation</td>
            ...
            if ($page_documents) { ?>
                <div class="tab-pane fade" id="appointment-documents">
                    <div class="panel panel-default">
                        <div class="panel-head">
                            <div class="panel-title">Scans & Reports | <?php echo $result['name']; ?>
                                | <?php echo date_format(date_create($result['patient_dob']), $common['info']['date_format']); ?></div>
            ...
            if ($invoice_view || $invoice_add) { ?>
                <div class="tab-pane fade" id="appointment-invoice">
                    <div class="panel panel-default">
                        <div class="panel-head">
                            <div class="panel-title">Invoice | <?php echo $result['name']; ?>
                                | <?php echo date_format(date_create($result['patient_dob']), $common['info']['date_format']); ?></div>
                        </div>
                        <div class="panel-body">
            ...
            if ($page_prescriptions) { ?>
                <div class="tab-pane fade" id="appointment-prescription">
                    <div class="panel panel-default">
                        <div class="panel-head">
                            <div class="panel-title">Prescription | <?php echo $result['name']; ?>
                                | <?php echo date_format(date_create($result['patient_dob']), $common['info']['date_format']); ?></div>
            ...
            if ($page_sendmail) { ?>
                <div class="tab-pane fade show <?php echo isset($doc_type) ? 'show active' : ''; ?>"
                    ...
                    <div class="panel panel-default">
                        <div class="panel-head">
                            <div class="panel-title"><?php echo (isset($doc_type) && $doc_type != 'to_patient_or_gp') ? 'Send email to the referrer' : 'Send Email to Patient'; ?>
                        ...
                        <form action="<?php echo URL_ADMIN . DIR_ROUTE . 'appointment/sendmail'; ?>" method="post"
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <label>To</label>
                                    <?php if (isset($doc_type) && $doc_type == 'third_party') { ?>
                                        <input type="text" value="<?php echo $result['third_party_name'] ?>"
                                               class="form-control"
                                               readonly>
                                    ...
                                    <?php if (isset($doc_type) && $doc_type == 'third_party') { ?>
                                        <input type="hidden" name="mail[email]"
                                               value="<?php echo $result['third_party_email']; ?>"
                                               readonly>
                                    <?php } ?>
                                ...
                                <div class="form-group" style="text-align: left;">
                                    ...
                                    <input type="hidden" name="mail[attached_leaflets]" id="attached_leaflets"
                                           value=""/>
                                    <a class="btn btn-info btn-sm" class="btn btn-secondary btn-sm" data-toggle="modal"
                                       data-target="#attach-file">Attach Leaflets</a>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" value=""
                                                   name="mail[attachment]" id="mail_appointment" checked>
                                            <?php if (isset($doc_type) && $doc_type == 'to_optom') { ?>
                                                <label class="custom-control-label" for="mailPdf"
                                                       id="appointment_mail_file_name">Optom Letter</label>
                                            <?php } ?>
                                            <?php if (isset($doc_type) && $doc_type == 'third_party') { ?>
                                                <label class="custom-control-label" for="mailPdf"
                                                       id="appointment_mail_file_name">Third Party Letter</label>
                                            <?php } ?>
                                            <?php if (isset($doc_type) && $doc_type == 'to_patient_or_gp') { ?>
                                                <label class="custom-control-label" for="mailPdf"
                                                       id="appointment_mail_file_name">Patient / GP Letter</label>
                                            <?php } ?>
                                ...
                                <div class="form-group" style="text-align: left;">
                                    ...
                                    <a class="btn btn-info btn-sm" class="btn btn-secondary btn-sm" data-toggle="modal"
                                       data-target="#attach-external-file">Upload File</a>
                                </div>
                                <div class="col-lg-12">
                                    <div class="panel panel-default">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class="custom-control custom-checkbox mb-2">
                                            <input type="checkbox" name="pre_leaflets"
                                                   data-original="<?php echo $each['original_name'] . "(" . $each['doc_name'] . ")"; ?>"
                                ...
                                <?php } ?>
                                <div class="panel-footer text-center">
                                    <button type="submit" name="submit" onclick="attachLeafletFiles();"
                                            class="btn btn-primary">Attach Selected
                                    </button>
                                </div>
                            </div>
                        </div>
                ...
                <div id="attach-external-file" class="modal fade" role="dialog">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="<?php echo URL_ADMIN . DIR_ROUTE . 'attach/documents'; ?>"
                                      class="dropzone" id="attach-file-upload"></form>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="tab-pane fade" id="appointment-letters">
                <div class="panel panel-default">
                    <div class="panel-head">
                        <div class="panel-title">Download letter | <?php echo $result['name']; ?>
                            | <?php echo date_format(date_create($result['patient_dob']), $common['info']['date_format']); ?></div>
                    </div>
                    <div class="panel-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                            <span style="font-size: 16px; margin-right: 15px;">
                                                <a target="_blank"
                                                   href="index.php?route=appointment/letters&id=<?php echo $result['id']; ?>&doc_type=to_patient_or_gp&action=download"><i
                                ...
                                <?php if (!empty($result['referee_name'])) { ?>
                                    <tr>
                                        ...
                                        <td>
                                                <span style="font-size: 16px; margin-right: 15px;">
                                                    <a target="_blank"
                                                       href="index.php?route=appointment/letters&id=<?php echo $result['id']; ?>&doc_type=to_optom&action=download"><i
                                                                class="ti-download"></i></a>
                                                </span>
                                            <span style="font-size: 16px; margin-right: 15px;">
                                                    <a href="index.php?route=appointment/view&id=<?php echo $result['id']; ?>&doc_type=to_optom"><i
                                                                class="ti-email"></i></a>
                                                </span>
                                        </td>
                                    </tr>
                                <?php } ?>
                                <?php if (!empty($result['third_party_name']) && !empty($result['third_party_email'])) { ?>
                                    <tr>
                                        <td>To Third Party</td>
                                        <td>
                                                <span style="font-size: 16px; margin-right: 15px;">
                                                    <a target="_blank"
                                                       href="index.php?route=appointment/letters&id=<?php echo $result['id']; ?>&doc_type=third_party&action=download"><i
                                                                class="ti-download"></i></a>
                                                </span>
                                            <span style="font-size: 16px; margin-right: 15px;">
                                                    <a href="index.php?route=appointment/view&id=<?php echo $result['id']; ?>&doc_type=third_party"><i
                                                                class="ti-email"></i></a>
                                                </span>
                                        </td>
                                    </tr>
