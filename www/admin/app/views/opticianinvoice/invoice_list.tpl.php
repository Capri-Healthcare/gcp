...
<div class="page-title">
    <div class="row align-items-center">
        ...
        <div class="col-sm-8 text-right">
            ...
            <?php if ($page_add) { ?>
                <a href="<?php echo URL_ADMIN.DIR_ROUTE.'optician/invoice/add&id=0'; ?>" class="btn btn-primary btn-sm"><i class="ti-plus pr-2"></i> New Invoice</a>
            <?php } ?>
        </div>
    </div>
</div>
                                ...
                                <td class="table-action">
                                    <?php if ($page_view || $page_edit) { ?>
                                        <div class="dropdown d-inline-block">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right export-button">
                                                <?php if ($page_view) { ?>
                                                    <li><a href="<?php echo URL_ADMIN.DIR_ROUTE.'optician/invoice/view&id='.$value['id'];?>"><i class="ti-layout-media-center-alt pr-2"></i>View</a></li>
                                                <?php } if ($page_edit) { ?>
                                                    <li><a href="<?php echo URL_ADMIN.DIR_ROUTE.'optician/invoice/edit&id='.$value['id'];?>"><i class="ti-pencil-alt pr-2"></i>Edit</a></li>
                                                 <?php } if ($page_pdf) { ?>
                                                    <li><a href="<?php echo URL_ADMIN.DIR_ROUTE.'optician/invoice/pdf&id='.$value['id'];?>" target="_blank"><i class="ti-pencil-alt pr-2"></i>PDF/Print</a></li>
                                                <?php } ?>
                                            </ul>
                                        </div>
                                    <?php } if ($page_delete) { ?>
