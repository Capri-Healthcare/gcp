...
<div class="page-title">
    <div class="row align-items-center">
        ...
        <div class="col-sm-6 text-right">
            <a href="<?php echo URL_ADMIN . DIR_ROUTE . 'optician-referral/view&id=' . $result['id']; ?>" class="btn btn-white btn-sm"><i class="ti-calendar text-primary mr-2"></i> View Referral Details</a>
        </div>
    </div>
</div>
            ...
            <?php if ($page_edit) { ?>
                <div class="tab-pane  <?php echo (isset($_GET['document']) ? 'active' : '') ?>" id="appointment-documents">
                    <div class="row">
                        ...
                        <!--                                   href="-->
                        <?php //echo URL_ADMIN . DIR_ROUTE . 'optician-referral/report/reportsExport&id=' . $result['id']; 
                        ?>
                        <!--"><i-->
                    ...
                    <div class="panel-footer text-center">
                        <a href="<?php echo URL_ADMIN . DIR_ROUTE . 'optician-referral/edit&id=' . $_GET['id'] . '&status=NEW'; ?>" class="btn btn-primary"><i class="ti-save-alt pr-2"></i> Submit Referral
                        </a>
                    </div>
                </div>
            <?php } ?>
