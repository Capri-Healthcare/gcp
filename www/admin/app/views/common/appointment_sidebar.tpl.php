            ...
            <div class="form-group mb-2">
                ...
                <div class="input-group">
                    ...
                    if (isset($_GET['referralid'])) { ?>
                        <input type="hidden" name="appointment[referralid]" value="<?php echo $_GET['referralid'] ?>"
                               class="form-control">
                    <?php } ?>
                    <input type="hidden" name="appointment[hospital_code]"
                           value="<?php echo isset($hospital_code) ? $hospital_code : null ?>" class="form-control">
                </div>
            </div>
            <div class="form-group mb-2">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="appointment[mail]"
                           ...
                           class="form-control patient-mail" placeholder="Enter Email Address . . ." required>
                </div>
            </div>
            <div class="form-group mb-2">
