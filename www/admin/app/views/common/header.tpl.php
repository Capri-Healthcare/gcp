...
<body>
    <div class="wrapper <?php if (!empty($common['theme']['layout'])) { echo ' '.$common['theme']['layout']; } ?>">
        ...
        <div id="main-wrapper" class="<?php if (!empty($common['theme']['layout_fixed'])) { echo ' '.$common['theme']['layout_fixed']; } if (!empty($common['theme']['side_menu'])) { echo ' menu-'.$common['theme']['side_menu']; }  if (!empty($common['theme']['layout_menu'])) { echo ' '.$common['theme']['layout_menu']; }?>">
            ...
            <!-- Menu Wrapper -->
            <?php if(!empty($common['admin_menu'])){    ?>
            ...
            <div class="page-hdr <?php echo $common['theme']['header_color']; ?>">
                <div class="row align-items-center">
                    ...
                    <?php if(isset($_GET['route']) AND $_GET['route'] == "appointment/videoConsultation"){  ?>
                    ...
                    <div class="col-8 col-md-5 page-hdr-right">
                        ...
                        <?php if(isset($_GET['route']) and $_GET['route'] == 'appointment/videoConsultation'){  
                                    if(isset($result)) {     ?>
                                        <div class="top_name" style="color: #fff;">
                                            <div class="top_info" style="display: inline-block; width: 100%;">
                                                <a class="m-0 text-primary" style="display: inline-block; color: #fff !important;"><?php echo $result['name'] ?></a>
                                                <span style="margin-left: 20px; border-left: 1px solid #fff; padding-left: 20px;"><?php echo $result['mobile'] ?></span>
                                            </div>
                                            <p class="m-0"><?php echo $result['message'] ?></p>
                                        </div>
                                
                            <?php   } else { ?>
                                    <div class="top_name" style="color: #fff;">
                                            <div class="top_info" style="display: inline-block; width: 100%;">
                                                <a class="m-0 text-primary" style="display: inline-block; color: #fff !important;"><?php echo isset($doctor_data['name']) ? $doctor_data['name'] : '' ?></a>
