...
{
	public function notifyPatientBySMS($appointment_id, $action){

		$this->load->model('appointment');
		$appointment = $this->model_appointment->getAppointment($appointment_id);
		$appointment_time = date("D, F j g:i a", strtotime($appointment['date'] . ' ' . $appointment['time']));

		switch($action){
			case 'UPDATE_APPOINTMENT':
				$message = TEXT_MSG_APPOINTMENT_REMINDER;
				break;
	...
	public function validateMobileNumber($phone_number)
	{
