...
class Patient extends Model
{
    ...
    public function updatePatient($data)
    {
		...
		`address` = ?, `nhs_patient_number` = ?, `nhs_hospital_number` = ?, `gp_practice` = ?, `gp_address` = ?, `history` = ?, `other` = ?,  `is_glaucoma_required` = ?, `gcp_followup_frequency` = ?, `first_payment` = ?, `regular_payment` = ? ,
		...
		WHERE `id` = ?",
            array($this->database->escape($data['title']), $this->database->escape($data['firstname']), $this->database->escape($data['lastname']), $data['mail'], $this->database->escape($data['mobile']),
                ...
                $data['address'], $data['nhs_patient_number'], $data['nhs_hospital_number'], $data['gp_practice'], $data['gp_address'], $data['history'], $data['other'],$this->database->escape($data['gcp_required']), $this->database->escape($data['followup']), $this->database->escape($data['first_payment']), $this->database->escape($data['regular_payment']),
